  ...
  return function (InnerComponent) {
    ...
    function (_React$Component) {
      ...
      function WithStyles(props) {
        ...
        _this.mergeClassesProp = memoize$2(function (sheetClasses, classesProp) {
...
export default jss;
export { JssContext, JssProvider, RuleList, SheetsManager, SheetsRegistry, ThemeProvider, cachePlugin as cache, camelCase, jssCompose as compose, create, createGenerateId, create$2 as createJsx, createRule, createTheming, createUseStyles, defaultUnit, jssExpand as expand, jssExtend as extend, functionPlugin as functions, getDynamicStyles, jssGlobal as global, hasCSSTOMSupport, jssIsolate as isolate, jss$1 as jss, createElement as jsx, jssNested as nested, observablePlugin as observable, create$1 as preset, jssPropsSort as propsSort, registry as sheets, configureStyled as styled, templatePlugin as template, toCssValue, useTheme, jssVendorPrefixer as vendorPrefixer, createWithStyles as withStyles, withTheme };
